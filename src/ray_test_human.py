...
from rzlib.env.simple_rl_player import embed_battle_internal
from rzlib.env.policy_player import PolicyPlayer
...
async def test():
    policy = Policy.from_checkpoint("../results/ppo_toy_15/iter_00000")
