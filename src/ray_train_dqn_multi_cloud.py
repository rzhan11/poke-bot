...
_num_learner_workers = 4
_num_rollout_workers = int(1 * (_num_cpus - _num_eval_workers - _num_learner_workers))
_num_envs_per_worker = 1
_num_workers = _num_rollout_workers + _num_eval_workers + _num_learner_workers
...
ppo_config = (
    ...
    .rollouts(
        ...
        rollout_fragment_length=5000 // _num_cpus,
    )
    .evaluation(
    ...
    .resources(
        num_gpus=_num_gpus,
        num_learner_workers=_num_learner_workers,
        # num_cpus=_num_cpus,
...
_num_iters = 10000
_checkpoint_freq = 10
_checkpoint_base_folder_name = "../results/dqn_rllib_multi4g"
...
print(json.dumps({
    ...
    "_num_learner_workers": _num_learner_workers,
    "_num_eval_workers": _num_eval_workers,
}, indent=2))
